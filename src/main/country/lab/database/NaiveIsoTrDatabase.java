...
public class NaiveIsoTrDatabase extends Database{


    public NaiveIsoTrDatabase(Config config){
        super(config);
    }
    ...
    public void backtrackDatabase() {
        ...
        switch (e.getType()) {
            ...
            case WRITE:
                ...
                if(!writeEvents.isEmpty() && writeEvents.get(writeEvents.size()-1).getObservationSequenceIndex() == e.getObservationSequenceIndex()){
