...
public class TestTwitter {
    ...
    private static final Tweet t0 = new Tweet("t0", "Hello", 0);
    private static final Tweet t1 =new Tweet("t1", "World", 1);
    ...
    private static void assertNW_TL(){
        var tw = Twitter.getTwitterSession(0);
        tw.begin();
    ...
    public static void doOperations1(){
        ...
        tw.begin();
        tw.publishTweet(a, t0);
        tw.end();

        tw.begin();
        tw.publishTweet(a, t1);
        tw.end();
    }
