...
argsList=(
  "-s src/benchmarks/shoppingCart/database/store.in src/benchmarks/shoppingCart/application-scalability/update-update-update/uuu3.in src/benchmarks/shoppingCart/application-scalability/update-update-update/uuu4.in src/benchmarks/shoppingCart/application-scalability/update-update-update/uuu5.in"
  "-d src/benchmarks/tpcc/database/districts.in -n src/benchmarks/tpcc/database/neworder.in -i src/benchmarks/tpcc/database/item.in -w src/benchmarks/tpcc/database/warehouse.in -s src/benchmarks/tpcc/database/stock.in -l src/benchmarks/tpcc/database/orderline.in -c src/benchmarks/tpcc/database/customer.in -o src/benchmarks/tpcc/database/order.in src/benchmarks/tpcc/application-scalability/update-update-update-strong/uuu5.in src/benchmarks/tpcc/application-scalability/update-update-update-strong/uuu4.in src/benchmarks/tpcc/application-scalability/update-update-update-strong/uuu3.in"
  "-p src/benchmarks/wikipedia/database/page.in -r src/benchmarks/wikipedia/database/revision.in -t src/benchmarks/wikipedia/database/text.in -u src/benchmarks/wikipedia/database/user.in -w src/benchmarks/wikipedia/database/watchlist.in src/benchmarks/wikipedia/application-scalability/update-read-read/urr0.in src/benchmarks/wikipedia/application-scalability/update-read-read/urr1.in src/benchmarks/wikipedia/application-scalability/update-read-read/urr2.in"
)
...
twitterArgs=(
  ...
  "-u src/benchmarks/twitter/database/users.in -t src/benchmarks/twitter/database/tweets.in -f src/benchmarks/twitter/database/follows.in -r src/benchmarks/twitter/database/followers.in src/benchmarks/twitter/application-scalability/update-read-update/uru3.in src/benchmarks/twitter/application-scalability/update-read-update/uru4.in src/benchmarks/twitter/application-scalability/update-read-update/uru5.in"
  "-u src/benchmarks/twitter/database/users.in -t src/benchmarks/twitter/database/tweets.in -f src/benchmarks/twitter/database/follows.in -r src/benchmarks/twitter/database/followers.in src/benchmarks/twitter/application-scalability/update-update-update/uuu0.in src/benchmarks/twitter/application-scalability/update-update-update/uuu1.in src/benchmarks/twitter/application-scalability/update-update-update/uuu2.in"
  "-u src/benchmarks/twitter/database/users.in -t src/benchmarks/twitter/database/tweets.in -f src/benchmarks/twitter/database/follows.in -r src/benchmarks/twitter/database/followers.in src/benchmarks/twitter/application-scalability/update-update-update/uuu3.in src/benchmarks/twitter/application-scalability/update-update-update/uuu4.in src/benchmarks/twitter/application-scalability/update-update-update/uuu5.in"
)
